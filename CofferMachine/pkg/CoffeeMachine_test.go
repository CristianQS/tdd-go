...
func Test_should_create_a_tea_drink_with_no_sugar_command(t *testing.T) {
	...
	var coffeeMachine = NewCoffeeMachine(mockDrinkMaker, &model.Drink{DrinkType: enums.Tea, SugarQuantity: 0})
...
func Test_should_create_a_coffee_drink_with_no_sugar_command(t *testing.T) {
	ctrl := gomock.NewController(t)
	mockDrinkMaker := NewMockDrinkMaker(ctrl)
	var coffeeMachine = NewCoffeeMachine(mockDrinkMaker,&model.Drink{DrinkType: enums.Coffee, SugarQuantity: 0})
...
func Test_should_create_a_chocolate_drink_with_two_sugar_and_one_stick_command(t *testing.T) {
	ctrl := gomock.NewController(t)
	mockDrinkMaker := NewMockDrinkMaker(ctrl)
	var coffeeMachine = NewCoffeeMachine(mockDrinkMaker,&model.Drink{DrinkType: enums.Chocolate, SugarQuantity: 2})
